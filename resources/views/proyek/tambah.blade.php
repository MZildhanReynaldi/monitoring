...
<body>
    ...
    <div class="konten">
        <h3>Membuat Proyek</h3>
        <div class="row">
            <div class="col">
                <form method="POST" action="{{route('tambah_proyek')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="title" class="form-label">Nama Proyek</label>
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Kontrak</label>
                        <input type="text" class="form-control" style="background-color: lightgrey;" id="title"
                            name="kontrak">
                    </div>
